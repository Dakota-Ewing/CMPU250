...
%DHDT is the array in which we hold the change in the human population at a
%given time step.
DHDT(To:Steps) = 0;
...
Kpy = 0.0002;
%Khf is the fishing rate of the Humans towards Tuna.
Khy = 0.1;
%Khf is the fishing rate of the Humans towards Sharks.
Khp = 0.1;
...
while t <= Steps
    ...
    Ydeaths = Kyp * Y(t) * P(t) + Khy * Y(t) * H(t);
    dy = Ybirths - Ydeaths;
...
%prints the average growth rate of the human population over the time span.
mean(DHDT)
